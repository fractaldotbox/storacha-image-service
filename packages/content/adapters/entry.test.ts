		...
		const patterns = [
			{
				id: "100",
				imageSrc:
					"bafybeifpiqvtu3tpmqtefd7dpx2dkcjorfwwn3mdhpqpb3egmbthjr57ua/100.png",
				contentSrc:
					"bafybeifpiqvtu3tpmqtefd7dpx2dkcjorfwwn3mdhpqpb3egmbthjr57ua/100.md",
			},
			{
				id: "101",
				imageSrc:
					"bafybeifpiqvtu3tpmqtefd7dpx2dkcjorfwwn3mdhpqpb3egmbthjr57ua/101.png",
				contentSrc:
					"bafybeifpiqvtu3tpmqtefd7dpx2dkcjorfwwn3mdhpqpb3egmbthjr57ua/101.md",
			},
			{
		...
		test("#generateStorachaSpaceEntries", async () => {
			...
			expect(entries).toEqual([
				...
				},
				{
					id: "999",
					imageSrc:
						"bafybeid6jwaslutkti3hl4tflfwn4mkzqz3lld2rz7xoainn7u4sfhck5y/999.md",
					contentSrc:
						"bafybeid6jwaslutkti3hl4tflfwn4mkzqz3lld2rz7xoainn7u4sfhck5y/999.md",
				},
			]);
